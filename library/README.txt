...
a persistence unit "libraryPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "library/pom.xml":
...
artifact ("library.war") is already built. You can build
